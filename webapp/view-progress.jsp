...
<%
    ...
    // Workout logs list
    List<Map<String, Object>> workoutLogs = new ArrayList<>();
    
    // Load statistics and workout history
    ...
    try {
        ...
        // Get workout history
        String sql4 = "SELECT ul.log_id, ul.log_date, ul.notes, w.name as workout_name, " +
        ...
        while (rs.next()) {
            ...
            log.put("logDate", rs.getString("log_date"));
            log.put("notes", rs.getString("notes"));
            log.put("workoutName", rs.getString("workout_name"));
            log.put("workoutType", rs.getString("type"));
            log.put("duration", rs.getInt("duration"));
            log.put("caloriesBurned", rs.getInt("calories_burned"));
            workoutLogs.add(log);
        }
...
<head>
    ...
    <title>FitTrack - My Progress</title>
    ...
    <div class="dashboard-container">
        ...
        <nav class="sidebar" id="sidebar">
            ...
            <div class="sidebar-nav">
                <div class="nav-section">
                    ...
                    <a href="view-progress.jsp" class="nav-item active">
        ...
        <main class="main-content">
            <div class="page-header">
                ...
                <p class="page-subtitle">Track your fitness journey and see how far you've come, <%= user.getUsername() %>!</p>
            </div>
            ...
            <div class="card">
                ...
                <% if (!workoutLogs.isEmpty()) { %>
                    <table class="workout-table">
                        ...
                        <tbody>
                            <% for (Map<String, Object> log : workoutLogs) { %>
                                <tr>
                                    <td><%= log.get("logDate") %></td>
                                    <td><strong><%= log.get("workoutName") %></strong></td>
                                    <td>
                                        <span class="workout-type <%= ((String)log.get("workoutType")).toLowerCase() %>">
                                            <%= log.get("workoutType") %>
                                        </span>
                                    </td>
                                    <td><%= log.get("duration") %> min</td>
                                    <td><%= log.get("caloriesBurned") %> cal</td>
                                    <td>
                                        <%= log.get("notes") != null && !((String)log.get("notes")).trim().isEmpty() 
                                            ? log.get("notes") : "-" %>
                                    </td>
                                </tr>
                            <% } %>
                ...
                <% } else { %>
                    <div class="no-workouts">
                        <i class="fas fa-dumbbell" style="font-size: 3rem; color: #cbd5e1; margin-bottom: 1rem;"></i>
